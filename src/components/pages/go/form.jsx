                    ...
                    <div>
                        <div className="mt-0 pt-4 p-2">
                            ...
                            <p className="md:w-3/5 leading-8 text-base">
                                ...
                                Component that uses MongoDB. This is mostly just
                                to be used by me and my friends. But, if you
                                want to use it, you can. However, don't post
                                anything illegal. I regularly delete all the
                                data from the database. So, don't expect your
                                links to be there forever.
                            </p>
                            <h2 className="text-xl font-bold py-2">
                                NoobShort CLI!
                            </h2>
